...
<style>
    .btn-primary {
        background-color: #0024c9; /* Azul oscuro */
        border-color: #2c3e50;
    }
    .btn-primary:hover {
        background-color: #2b4de4; /* Azul un poco más claro al hacer hover */
        border-color: #34495e;
    }
    .btn-success {
        background-color: #380eab; /* Verde para Actualizar */
        border-color: #061662;
    }
    .btn-success:hover {
        background-color: #5a73ea;
        border-color: #2ecc71;
    }
    .btn-danger {
        background-color: #e71212; /* Rojo para Eliminar */
        border-color: #e74c3c;
    }
    .btn-danger:hover {
    ...
    .fa-pen, .fa-trash, .fa-folder-plus {
        color: #ffffff;
    }
</style>
</head>
...
<section class="px-5 py-5">
    <div class="container" style="text-align: center;">
        ...
        <button class="btn btn-primary" 
            ...
            <i class="fa-solid fa-folder-plus"></i> Agregar Pago
        </button>
    </div>
